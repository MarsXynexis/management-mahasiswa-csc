    ...
    <main class="flex-grow p-6 md:p-10">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-10">
                <form action="controller/store-student.php" method="POST" enctype="multipart/form-data" class="space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input name="nim" type="text" placeholder="220101001" class="w-full px-5 py-4 rounded-2xl bg-slate-50 border-none focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all">
                        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="border-2 border-dashed border-slate-200 rounded-[2rem] p-10 flex flex-col items-center justify-center text-center hover:bg-indigo-50/50 transition-all cursor-pointer relative">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-indigo-600 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                            </svg>
                            <p class="font-bold text-slate-700 text-sm">Klik atau seret foto ke sini</p>
                            <input name="profile_picture" type="file" class="absolute inset-0 opacity-0 cursor-pointer">
                        </div>
                    </div>
                    <div class="flex gap-4 pt-4">
                        <button type="submit" name="submit" class="flex-grow bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-2xl shadow-xl shadow-indigo-100 transition-all">Simpan Data</button>
